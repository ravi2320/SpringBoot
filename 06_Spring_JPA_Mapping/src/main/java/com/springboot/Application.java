...
//		p1.setProdName("Redmi");
//		
//		Product p2 = new Product();
//		p2.setProdName("Samsung");
//		
//		Category c1 = new Category();
//		c1.setCategoryName("Electric");
//		
//		Category c2 = new Category();
//		c2.setCategoryName("Digital");
//		
...
//		Category ca = catRepo.findById(1).get();
//		System.out.println(ca);
//		ca.getProducts().forEach(e->System.out.println(e.getProdName()));
